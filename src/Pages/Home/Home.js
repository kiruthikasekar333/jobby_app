...
const Home = () => {
  ...
  return (
    <div className="main-container" style={{ backgroundImage: themeStyles.backgroundImage }}>
    <div className="home-container">
      <div className="content">
        <h4 style={{color: "white"}}>OUR HIGHLIGHTS:</h4>
        <div className="carousel">
          {highlights.map((highlight, index) => (
            ...
            >
              ...
              <p style={{color: "black"}}>{highlight.description}</p>
            </div>
          ))}
        </div>
      </div>
